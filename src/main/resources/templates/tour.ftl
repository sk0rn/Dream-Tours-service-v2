...
<@i.page>
    ...
    <h4><span class="badge badge-info">${tour.getName()}</span></h4>
    <table>
        <tr>
            <td>
    ...
    <div name="tourName">
        ...
        <p class="text-justify">${tour.getDescr()}</p>
            ...
            <nobr>
                ...
                <iframe src="https://yandex.ru/map-widget/v1/-/${tour.getMapUrl()}" width="560" height="315" frameborder="1" allowfullscreen="true"></iframe>
            </nobr>
    ...
    <div id="accordion">
        <div class="card">
            ...
            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="card-body">
                    ...
                    1.Загранпаспорт + 1 ксерокопия первой страницы; Паспорт РФ Ксерокопия российского паспорта (1-ю
                    страницу + 2.страница с регистрацией);<br>
                    3.Анкета для посольства Анкета для посольства (2 шт);<br>
                    4.Анкета-опросник (1шт);<br>
                    5.Фото 45х45 мм Фотографии цветные или черно-белые 45х45 мм, сделанные недавно и соответствующие
                    современному облику заявителя (2 шт);<br>
                    6.Справка с работы Справка с места работы на фирменном бланке компании с указанием должности и
                    оклада; ВНИМАНИЕ: турист не должен сам себе подписывать справку<br>
                    7.Авиабилет в Японию;<br>
                    8.Доверенность Простая письменная форма на подачу документов в посольство, в случае если подает
        ...
        <div class="card">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                <div class="card-body">
                    Лучше всего посещать Японию весной (март-апрель) или осенью (октябрь-ноябрь). Температура воздуха в
                    это время<br>
                    обычно не опускается ниже 17-20оС днем и 10-15оС - ночью. Весной и осенью в стране обычно проходит
                    множество<br>
                    разнообразных праздников. Самый плохой сезон - лето, когда идут дожди, а температура достигает +40
                    градусов.
                    <br><br>
                    Национальная денежная единица страны - иена. $1 равен 130 иенам. Обменять валюту лучше всего в
                    ...
                    <br><br>
                    В Японии - левостороннее движение, поэтому брать автомобиль напрокат гражданам России нет никакого
                    смысла.<br>
                    Самое удобное средство передвижения - общественный городской транспорт. Оплата проезда на метро и
                    автобусе<br>
                    зависит от продолжительности проезда. Минимальная оплата проезда в метро - 150 иен, в автобусе - 220
                    иен.
                    <br><br>
                    ...
                    <br><br>
                    Международный аэропорт Нарита находится в часе езды от Токио. Лучше всего добираться из него в центр
                    японской<br>
                    столицы на автобусе-экспрессе "шаттл-бас".
                    <br><br>
                    При выезде из страны в аэропорту каждый пассажир обязан оплатить сбор в размере две тысячи иен.<br>
                    <br><br>
                    Минимальный срок для получения японской визы - 21 день. Консульский сбор при этом составляет 158
                    рублей.<br>
                    Для получения визы необходима поддержка со стороны японских партнеров.
                    <br><br>
                    Стоимость одной минуты телефонного разговора с городами России - примерно $3. Выход на международную
                    линию - 001.<br>
                    Для звонков необходима телефонная карта.
                    <br><br>
                    Разница во времени с Москвой составляет +6 часов зимой и +5 часов летом.<br>
                    <br><br>
                    Японская кухня весьма специфична. Блюда национальной кухни подаются сразу все, но в разнообразном
                    наборе.<br>
                    Для начала рекомендуется попробовать традиционные "суси" и "сасими" (блюда из сырой рыбы),<br>
                    а также "мраморное" мясо "кобэгю". Из напитков рекомендуется попробовать рисовую водку "сакэ",
